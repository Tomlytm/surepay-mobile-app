...
import ChangePasswordModalNative from "@/components/ChangePassword"; // Import the ChangePasswordModalNative component
...
const AccountSettingsScreen: React.FC<AccountSettingsScreenProps> = ({ onBack }) => {
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.content}>
        ...
        <View style={styles.section}>
          ...
          <Text style={styles.verificationDescription}>
            When this is on, You will be required to provide a verification code whenever you want to log in to your
            account
          </Text>
        </View>
      ...
      <ChangePasswordModalNative visible={passwordModalVisible} onClose={() => setPasswordModalVisible(false)} />
    </SafeAreaView>
  )
}
